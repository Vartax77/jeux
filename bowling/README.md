...
- **Physique** : vitesses min/max, force et début du crochet, masses, frottements et rebonds (valeurs « réelles », converties en interne), inertie et forme des quilles, seuils de chute, attente maximale. Les changements s'appliquent immédiatement (sauf la forme des quilles : rechargement).
