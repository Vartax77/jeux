...
export const SCHEMA = [
  {
    id: 'manette', titre: 'Manette', champs: [
      ...
      { id: 'aMax', type: 'nombre', defaut: 22, min: 5, max: 60, pas: 1, unite: 'm/s²', profil: true, libelle: 'Pic de saturation (aMax)',
  ...
  },
  {
    id: 'physique', titre: 'Physique', champs: [
      ...
      { id: 'gainEffet', type: 'nombre', defaut: 2.5, min: 0, max: 8, pas: 0.25, unite: 'm/s²', libelle: 'Force du crochet',
        aide: 'Accélération latérale à effet plein en fin de piste. 2,5 dévie la boule d’environ 25 cm ; 5 la fait traverser la piste.' },
      { id: 'debutCrochet', type: 'nombre', defaut: 60, min: 0, max: 95, pas: 5, unite: '%', libelle: 'Début du crochet (position sur la piste)',
        aide: 'Avant ce point la boule glisse sur l’huile et va droit ; après, le crochet monte progressivement.' },
      ...
      { id: 'masseQuille', type: 'nombre', defaut: 1.2, min: 0.6, max: 3, pas: 0.05, unite: 'kg', libelle: 'Masse d’une quille',
        aide: 'Une vraie quille pèse 1,55 kg ; 1,2 rend le jeu plus généreux (plus de strikes dans la poche).' },
      ...
      { id: 'frottementQuille', type: 'nombre', defaut: 0.2, min: 0, max: 1, pas: 0.05, libelle: 'Frottement deck / quilles',
        aide: 'Plus bas : les quilles glissent davantage et s’entraînent mieux.' },
      { id: 'rebondQuille', type: 'nombre', defaut: 0.35, min: 0, max: 0.9, pas: 0.05, libelle: 'Rebond deck / quilles' },
      ...
      { id: 'rebondQuilleQuille', type: 'nombre', defaut: 0.6, min: 0, max: 0.95, pas: 0.05, libelle: 'Rebond quille / quille',
        aide: 'Plus haut : les quilles se renvoient mieux (action de quilles).' },
      { id: 'rebondKickback', type: 'nombre', defaut: 0.6, min: 0, max: 0.95, pas: 0.05, libelle: 'Rebond sur les parois du deck' },
      { id: 'amortissementQuille', type: 'nombre', defaut: 0.2, min: 0, max: 0.9, pas: 0.05, libelle: 'Amortissement de rotation des quilles',
        aide: 'Plus haut : les quilles se calment plus vite (comptage plus rapide).' },
  ...
  },
  {
    id: 'cameras', titre: 'Caméras', champs: [
      ...
      { id: 'distanceCoupeImpact', type: 'nombre', defaut: 2, min: 0.5, max: 5, pas: 0.25, unite: 'm', libelle: 'Distance des quilles où la caméra coupe sur l’impact' },
