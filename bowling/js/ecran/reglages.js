...
export const SCHEMA = [
  ...
  },
  {
    id: 'cameras', titre: 'Caméras', champs: [
      ...
      { id: 'ralentiStrike', type: 'choix', defaut: 'strike', libelle: 'Ralenti de l’action de quilles', options: [['strike', 'Sur strike et spare'], ['tous', 'À chaque lancer'], ['aucun', 'Jamais']] },
      { id: 'dureeRalenti', type: 'nombre', defaut: 2.8, min: 1, max: 6, pas: 0.2, unite: 's', libelle: 'Durée du ralenti' },
      { id: 'vitesseRalenti', type: 'nombre', defaut: 0.35, min: 0.1, max: 1, pas: 0.05, libelle: 'Vitesse du ralenti (1 = temps réel)' },
